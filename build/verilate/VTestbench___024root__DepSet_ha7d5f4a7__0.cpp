...
VL_INLINE_OPT void VTestbench___024root___nba_sequent__TOP__3(VTestbench___024root* vlSelf) {
    ...
    } else if ((0U == (IData)(vlSelfRef.Testbench__DOT__mul__DOT__work_cnt))) {
        vlSelfRef.Testbench__DOT__error = (1U != ([&]() {
                    VTestbench___024unit____Vdpiimwrap_mul_judge_TOP____024unit(vlSelfRef.Testbench__DOT__judge__DOT__multiplicand_reg, vlSelfRef.Testbench__DOT__judge__DOT__multiplier_reg, 
                                                                                ((0U 
                                                                                == (IData)(vlSelfRef.Testbench__DOT__mul__DOT__work_cnt))
                                                                                 ? vlSelfRef.Testbench__DOT__mul__DOT__product_reg
                                                                                 : 0ULL), __Vfunc_mul_judge__0__Vfuncout);
